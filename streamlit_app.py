...
.coach-eye.left{left:23px}
.coach-eye.right{right:22px;top:21px;width:27px;height:13px;border:0;border-bottom:4px solid #f2f0dc;border-radius:0 0 20px 20px;background:transparent;transform:rotate(-10deg)}
