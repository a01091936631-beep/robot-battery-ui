...
function petRobot(){if(state.cleaning){showToast("청소가 끝난 후 홈지니를 쓰다듬어 주세요.");return}state.heart=Math.min(100,state.heart+2);state.exp+=1;pulseRobot();spawnEffect("💖",7);levelCheck();render();showToast("홈지니의 기분이 좋아졌어요.")}
